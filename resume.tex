...
\section*{Research Experience}
    ...
    \itemHeadings
        ...
        \itemitems
            {Developed a testing apparatus to determine if a scaffold propagates an electric pulse between tissue samples.}
        \itemitems
            {Established a collaboration with the Costa Lab, and introduced a engineered cardiac tissue system into the lab.}
    \itemHeadings
...
\section*{Projects}
    \projHeadings
        {\textbf{Cardiac Tissue Tracking System} $|$ 
          \href{https://rianu.mrph.dev} {\emph{https://rianu.mrph.dev}}}
          {June 2020 -- Present}
        \projitems
            {\textbf{\emph{Project Goal:}} Develop a system that can track and analyze multiple engineered cardiac tissues simultaneously.}
        \itemitems
            {Created a web application to accept user input of post locations and used OpenCV libraries to track contractions.}
        \itemitems
            {Utilized Plotly.js libraries to build a graphing dashboard that allows for complex contractile function analysis.}
        \itemitems
            {Leveraged Docker containers to allow for simple, operating system agnostic deployment.}
% ------------------------------------------------------------------------
